...
> **Note:** this document was auto-generated by Claude Code. The numbers are real (measured from `torch.profiler` traces), but the prose around them hasn't been fully vetted and may be imprecise in places.
